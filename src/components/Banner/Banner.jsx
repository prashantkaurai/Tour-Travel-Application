            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                <p data-aos="fade-up" className="text-sm text-gray-500 tracking-wide leading-8">
                  Discover the world with us! We offer unforgettable travel experiences, from exotic destinations to hidden gems. 
                  Let us be your guide to unforgettable adventures and unforgettable memories. Join us on a journey of discovery and exploration!
                  <br />
                  Whether you're seeking thrilling adventures, cultural immersions, or serene escapes, we have the perfect travel experience for you.
                </p>
